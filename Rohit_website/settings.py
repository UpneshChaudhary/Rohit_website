"""
Django settings for Rohit_website project.
...
SECRET_KEY = 'django-insecure-n&g+5jhbytt6nc_7%+(@es-%c7flt5^j)&cslz=69=f13i*!__'
...
ROOT_URLCONF = 'Rohit_website.urls'
...
WSGI_APPLICATION = 'Rohit_website.wsgi.application'
